<div class="jumbotron text-center  -bottom" class=" text-center" style="margin-bottom:0;">
    ...
    <a href="https://www.youtube.com/channel/UCApZraAL3P3bjNIcz16bvTA?view_as=subscriber"><i class="fa fa-youtube fa-3x social" style="color:red;margin: 10px"></i></a>
    <a href="mailto:nhokquay0612@gmail.com"><i class="fa fa-envelope fa-3x social" style="margin: 10px"></i></a>
</div>